...
<body>
    ...
    <section class="hero-section">
        ...
        <div class="hero-wrapper-two">
            ...
            <div class="hero-slider-two">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-9">
                                ...
                                <div class="hero-content text-white text-center">
                                    <span class="ribbon">Tour & Travels</span>
                                    <h1 data-animation="fadeInDown" data-delay=".4s">Tour Travel & Adventure Camping
                                    </h1>
                ...
                <div class="single-slider">
                    <div class="image-layer bg_cover"
                        style="background-image: url(assets/images/hero/hero-two_img-4.jpg);"></div>
                    <div class="container-fluid">
                        <div class="row justify-content-center">
                            <div class="col-xl-9">
                                <!--=== Hero Content ===-->
    ...
    <section class="activity-section pb-60">
        <div class="container-fluid">
            <!--=== Slider Active Item ===-->
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    ...
                    <div class="cta-content-box text-center text-white wow fadeInUp">
                        ...
                        <a href="about.html" class="main-btn secondary-btn">Check Availability<i
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="footer-text">
                            <p>Copyright @ 2025 <span style="color: #F7921E;">GoWilds</span>, All Right Reserved</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <!--=== Footer Nav ===-->
