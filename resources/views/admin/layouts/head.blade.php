<head>
  ...
  <meta name="description" content="Wowdash by Pixcels Themes is a premium Bootstrap 5 admin dashboard template. It features a responsive, modern design with advanced UI components and customizable layouts for efficient web application management.">
  <meta name="keywords" content="admin dashboard, Bootstrap 5 template, responsive admin template, UI components, web application, premium dashboard, Pixcels Themes, customizable dashboard">
  <meta name="author" content="Pixcels Themes">
  <title>Admin Edelweiss</title>
